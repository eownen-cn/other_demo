! function(e) {
    ...
    return t.m = e, t.c = n, t.p = "", t(0)
            ...
            function i() {} Object.defineProperty(t, "__esModule", { value: !0 });
            var r = n(2),
                a = o(r),
                s = n(3),
                l = o(s),
            ...
            t.default = angular.module("zkyResume",[a.default, l.default, u.default]).service("resumeData", [function() { 
                    this.data = { cn: { header: { 
                        langList: ["中", "英"], titleList: [
                            { svg: "images/d_home.svg", title: "首页" }, 
                            { svg: "images/d_info.svg", title: "关于我" }, 
                            { svg: "images/d_skills.svg", title: "技能栈" }, 
                            { svg: "images/d_exp.svg", title: "经历" }, 
                            { svg: "images/d_works.svg", title: "作品集" }, 
                            { svg: "images/d_contact.svg", title: "联系我" }
                        ] 
            }, 
            footer: {}, 
            default: { quote: "生活是一种绵延不绝的渴望，渴望不断上升，变得更伟大而高贵。", 
            desList: ["我叫龙永凌", "一名前端研发工程师", "denny_loong@outlook.com"] }, 
            info: { title: "关于我", 
                infoList: [
                    { icon: "images/i_age.svg", key: "年龄", value: "24岁" }, 
                    { icon: "images/i_edu.svg", key: "学历", value: "专科" }, 
                    { icon: "images/i_site.svg", key: "坐标", value: "北京" }, 
                    { icon: "images/i_status.svg", key: "状态", value: "在职" }
                ], 
                desList: [
                    "两年互联网经验,一年半全职前端开发经验", 
                    "熟悉MVVM开发,深谙自动化,模块化开发之道", 
            ...
            works: { 
                ...
                worksList: [
                    ...
                    { 
                        title: "移动校园APP", 
                        des: "一站式、全生命周期的校园官方移动服务平台，涵盖PC、安卓、IOS、微信平台，上线学校包括中央财经大学，北京交通大学，中国戏曲学院，辽宁大学，西南科技大学等等，下载量数十万，深受学生老师喜爱。", 
                        url: "#" 
                    }, 
                    { 
                        title: "移动校园管理系统", 
            ...
            contact: { 
                ...
                typeList: [
                    { 
                        icon: "images/s_github.svg", 
                        url: "#" 
                    }, 
                    { 
                        icon: "images/s_sf.svg", 
                        url: "#" 
                    }, 
                    { 
                        icon: "images/s_blog.svg", 
                        url: "#" 
                    }, 
                    { 
                        icon: "images/s_zh.svg", 
                        url: "#" 
                    }, 
                    { 
                        icon: "images/s_wb.svg", 
                        url: "#" 
                    }
                ] 
            } 
        ...
        en: { 
            header: { 
                ...
                titleList: [
                    { 
                        svg: "images/d_home.svg", 
                        title: "home" 
                    }, 
                    { 
                        svg: "images/d_info.svg", 
                        title: "about" 
                    }, 
                    { 
                        svg: "images/d_skills.svg", 
                        title: "skills" 
                    }, 
                    { 
                        svg: "images/d_exp.svg", 
                        title: "exp" 
                    }, 
                    { 
                        svg: "images/d_works.svg", 
                        title: "works" 
                    }, 
                    { 
                        svg: "images/d_contact.svg", 
                        title: "contact" 
                    }
                ] 
            }, 
            ...
            default: { 
                ...
                desList: ["I am Long YongLing", "A front-end R & D engineer", "denny_loong@outlook.com"] 
            }, 
            info: { 
                title: "About Me", 
                infoList: [
                    { 
                        icon: "images/i_age.svg", 
                        key: "Age", 
                        value: "24" 
                    }, 
                    { 
                        icon: "images/i_edu.svg", 
                        key: "Edu.", 
                        value: "B.S." 
                    }, 
                    { 
                        icon: "images/i_site.svg", 
                        key: "Add.", 
                        value: "BeiJing" 
                    }, 
                    { 
                        icon: "images/i_status.svg", 
                        key: "Status", 
                        value: "On Job" 
                    }
                ], 
    ...
    this.extend = function(e, t) { 
        for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n]) 
            ...
            [
                "$window", function(e) {
                var t = "ontouchend" in e.document,
                    n = void 0;
                    n = { 
                    ...
                    this.event = n, 
                    this.isSupportTouch = t
                }
            ]
    ).component("lylResume", { templateUrl: "html/cmpt1.html", controllerAs: "zr", controller: i }).name
}, function(e, t) {
    "use strict";
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rHeader", [])
            .component("resumeHeader", { 
                templateUrl: "html/cmpt2.html", 
                controller: n, 
                bindings: { 
                    pageIndex: "=" 
                } 
            ...
            .directive("showNav", ["actionEvent", function(e) {
                function t(t, n) {
                    function o() { i.isShowNav = !i.isShowNav, t.$apply() }
                    var i = t.$ctrl;
                ...
                function n(n, o) {
                    function i(e) { "SPAN" === e.target.nodeName && (r.selectedLang = Number(e.target.dataset.index) + 1, n.$apply(), t.$broadcast("switchLang", r.selectedLang)) }
                    var r = n.$ctrl;
                ...
                function n(n, o) {
                    function i(t) { "EM" == t.target.nodeName && (+t.target.dataset.index !== r.pageIndex && !e.moving && (r.pageIndex = +t.target.dataset.index), r.isShowNav = !1, n.$apply()) }
                    var r = n.$ctrl;
            ...
            function n() {} Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rFooter", []).component("resumeFooter", 
                { 
                    templateUrl: "html/cmpt3.html", 
                    controllerAs: "rf", 
                    controller: n 
                }).name
        }, function(e, t, n) {
            ...
            t.default = angular.module("rMain", [r.default, s.default, c.default, d.default, p.default, f.default]).service("initArrow", [function() {
                ...
                this.stop = function() { 
                    ...
                    .addEventListener(e.event.start, function(e) { 
            ...
            .directive(
                ...
                [
                    ...
                    function s() { a[0].classList.add("dock-fill"), x[0].classList.add("cur-page"), x[b + 1].classList.add("next-page"), _.init(), t.stop(), a[0].addEventListener(i.event.start, c), a[0].addEventListener("mousewheel", l) }

                    function l(e) { w || e.wheelDelta < 0 && b == E - 1 || e.wheelDelta > 0 && 0 == b || (e.wheelDelta < 0 ? b++ : b--, g(b)) }

                    function c(e) { w || "touchstart" != e.type || (y = e.changedTouches[0].pageY, a[0].addEventListener(i.event.move, u)) }

                    function u(e) { w || (L = e.changedTouches[0].pageY - y, L < 0 && b == E - 1 || L > 0 && 0 == b || (f(), a[0].addEventListener(i.event.end, d))) }

                    function d() { w || (Math.abs(L) < 100 ? p() : g(k)) }

                    function m() { w = !1, o.moving = w, v(), a[0].removeEventListener("touchmove", u), a[0].removeEventListener("touchend", d) }
                    ...
                    function h() {
                        console.log("高仿作品，仅供学习参考，如有雷同，定是原版！") ;
                    }

                    function g(e) { r.$apply(function() { r.pageIndex = e }) }
                    ...
                    s(), r.$watch("pageIndex", function(e, t) {
                        ...
                        if (!w && "undefined" != typeof e) {
                            ...
                            if (w = "undefined" != typeof t, o.moving = w, Math.abs(r - t) > 1) {
                                var s = new Promise(function(e) { i[r].style.display = "block", i[r].style.transform = r > t ? "translateY(100%)" : "translateY(-100%)", n(function() { e() }, 200) });
                                s.then(function() { i[r].classList.add("active"), i[r].style.display = "", "undefined" != typeof t && (i[t].style.transform = r > t ? "translateY(-100%)" : "translateY(100%)", i[t].style.transition = "transform 0.5s") })
                    ...
                    }), r.$on("$destroy", function() { _.destroy(), a[0].removeEventListener("touchstart", c), a[0].removeEventListener("mousewheel", l) })
                }
                return { restrict: "E", link: r, template: "<div ng-transclude></div>", transclude: !0, replace: !0, scope: { pageIndex: "=" } }
            }]).name
        }, function(e, t) {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rContact", []).component("resumeContact", { templateUrl: "html/cmpt4.html", controller: n }).name, n.$inject = ["resumeData", "$rootScope", "$scope"]
        }, function(e, t) {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rDefault", []).component("resumeDefault", { templateUrl: "html/cmpt5.html", controller: n }).name, n.$inject = ["resumeData", "$rootScope", "$scope"]
        }, function(e, t) {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rWorks", []).component("resumeWorks", { templateUrl: "html/cmpt6.html", controller: n }).directive("switchWork", ["actionEvent", function(e) {
                function t(t, n, o) {
                    function i(e) { "I" === e.target.nodeName && (a += "-left" == e.target.className ? 90 : -90, r.style.transform = "rotateY(" + a + "deg)") }
            ...
            .directive("touchThreeD", ["$window", "actionEvent", function(e, t) {
                function n(n, o) {
                    ...
                    function r(e) { o[0].style.transform = "rotateY(0deg) rotateX(0deg)" }

                    function a() { c = o[0].offsetLeft, u = o[0].offsetTop }
                    var s = void 0,
                        l = void 0,
                        c = void 0,
                        u = void 0;
                    ...
                    o[0].addEventListener(t.event.move, i),
                     o[0].addEventListener("mouseout", r), 
                     e.onresize = a
                }
                return { restrict: "A", link: n }
            }]).directive("switchExp", ["actionEvent", function(e) {
                function t(t, n) {
                    function o(e) { "LI" == e.target.nodeName && e.target.dataset.index !== r.curIndex && (r.curIndex = e.target.dataset.index, a.style.opacity = "0", a.addEventListener("webkitTransitionEnd", i)) }

                    function i() { a.style.opacity = "1", t.$apply(function() { r.exp = r.expList[r.curIndex] }), a.removeEventListener("webkitTransitionEnd", i) }
                    var r = t.$ctrl,
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = angular.module("rInfo", []).component("resumeInfo", { 
        templateUrl: "html/cmpt8.html", 
        controller: n }).name, n.$inject = ["resumeData", "$rootScope", "$scope"]
}, function(e, t) {
    "use strict";
    ...
    t.default = angular.module("rSkill", [])
    .component("resumeSkill", 
    { 
        templateUrl: "html/cmpt9.html", 
        controller: n 
    })
    .name, 
    n.$inject = ["resumeData", "$rootScope", "$scope"]
}]);